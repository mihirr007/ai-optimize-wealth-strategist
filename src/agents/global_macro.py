...
def global_macro_agent(state: WealthAgentState, agent_id: str = "global_macro_agent"):
    ...
    signal = GlobalMacroSignal(
        signal="maintain",
        confidence=70.0,
        reasoning=f"Global Macro analysis with real-time market data for {len(symbols)} symbols",
        recommendations=["Consider Global Macro strategies", "Review current allocation"],
